...
namespace dotnet_api_oauth
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //With a Postgres Database. But can be changed to support other database types.
            //Reference http://www.npgsql.org/efcore/index.html
            //Reference https://www.npgsql.org/doc/connection-string-parameters.html
            //Reference https://www.nuget.org/packages/Npgsql/
